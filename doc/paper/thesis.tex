...
From those goals the following workpackages were defined. For a better overview they are assigned to categories. The categories are Architecture, Implementation, Validation and Environmental. Architecture is about defining how the system will look like and how it should work. Implementation is the effective implementation work for getting the system to run, this includes configuration and coding. Validation is about testing of the system. Environmental is everything that deals with project management and other workpackages that don't directly influence the system but need to be done.

The ID is a combination of the first letter of the category and a unique index. 
...
\begin{table}[h!]
  \begin{center}
    ...
    \begin{tabular}{c|l|c|l}
      \textbf{ID} & \textbf{Short description} & \textbf{Priority} & \textbf{Category} \\
      \hline
      E00 & Setting up \LaTeX document & h & Environmental \\
      E01 & Define workpackages and set deadlines & h & Environmental \\
			...
			E02 & Finish user documentation & m & Environmental \\
			E03 & Finish project documentation & h & Environmental \\ 
			E04 & Create project presentation & h & Environmental \\
			E05 & Create project poster & m & Environmental \\
			E06 & Create project video & l & Environmental \\
    \end{tabular}
  \end{center}
\end{table}
...
For the planning of this project the following milestones were created. Each coveres multiple workpackages. The mapping can be seen in the following table.
...
From the above milestones together with some dates defined from the project framework follows this timeplan.

...
description={A deterministic one way function that fullfills collision resistance and other cryptographic properties. Implementations are MD5, the SHA1,2,3 families.}}
\newglossaryentry{fs}{
name=file system, 
